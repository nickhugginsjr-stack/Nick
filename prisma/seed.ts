...
async function main() {
  ...
  const prospects = [
    ...
    {
      businessName: "Little Sprouts Learning Center",
      ownerName: "Renata Cole",
      phone: "+15555550109",
      industry: "Childcare",
      addressLine1: "88 Sprout Ln",
      city: "Sacramento",
      state: "CA",
      zip: "95814",
      relationshipStatus: "COLD" as const,
      script: "Lead with staff retention — childcare centers struggle to keep dependable staff.",
      quickFacts: "18 staff across two rooms. No prior contact.",
      lastContactedAt: null,
      notes: [],
      timeline: [],
    },
